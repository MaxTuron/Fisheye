    ...
    function getMediaCardDOM() {
        ...
        if (image === undefined) {
            ...
            div.innerHTML = `
             ...
             <div aria-label="${title} closeup view">
        ...
        `;
            ...
            //On écris le code HTML suivant
            div.innerHTML = `
             <button tabindex="0" onkeydown="openModalKey(event,${numeroPhoto})" class="imgButton"><img src="${picture}" alt="${title}, closeup view" class="hover-shadow" onclick="openModalLightbox(${numeroPhoto});currentMedia(${numeroPhoto})"></button>
             <h2 class="titre_media">${title}
             <div>
